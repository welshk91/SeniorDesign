...
//Image path, defaults to crappy soil image
gchar *imagePath = IMAGE_CRAPPY;

//Number of "job" selections the player has made 
int numChoices = 0;

//Keeps track of which plants were picked
int pickedClover = 0;
int pickedThorn = 0;
int pickedRye = 0;
int pickedSumac = 0;
...
static void acceptTime (void)
{
	...
	\tActions Done: ", actionsBuf,"\n", NULL);
		...
		/* Image for Soil View
		 * Doesn't seem to work. Looks like a refresh/update issue
		 */
		if(oxygenLvl>70){
...
/*
 * Not quite sure what this code does
 * This was skeleton code produced by my IDE
 */
static void
